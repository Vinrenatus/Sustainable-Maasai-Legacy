  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <article className="space-y-12">
        ...
        <section>
          <h2 className="text-3xl font-bold text-gray-800 mb-4">History and Tradition</h2>
          <div className="prose lg:prose-xl">
            <p>
          ...
          <img
            className="w-full h-80 object-cover rounded-lg shadow-md mt-6"
        ...
        <section>
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Who is a Maasai Warrior?</h2>
          <div className="prose lg:prose-xl">
            <p>
        ...
        <section>
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Why Become a Warrior?</h2>
          <div className="prose lg:prose-xl">
            <p>
        ...
        <section className="bg-gray-100 p-6 rounded-lg shadow-inner">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Key Facts About the Maasai</h3>
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>Homeland: Kenya and Tanzania</li>
            <li>Traditional Attire: Red shuka and intricate beadwork</li>
            <li>Language: Maa (a Nilotic language)</li>
            <li>Main Economic Activity: Cattle herding</li>
            <li>Rite of Passage: Warrior initiation and age-set transitions</li>
          </ul>
        </section>
      </article>
    </div>
